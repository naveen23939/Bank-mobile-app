...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(CardAlredyExitException.class)
    public ResponseEntity<ErrorResponceDto> handleCardAlreadyExistsException(CardAlredyExitException exception,
                                                                             WebRequest webRequest){
        ErrorResponceDto errorResponseDTO = new ErrorResponceDto(
                webRequest.getDescription(false),
